...
const SectorPerformance = () => {
  ...
  return !sectorPerformance ? (
    ...
    <div className={`sectorPerformance rounded-lg p-5 w-auto max-w-4xl mx-auto mt-10 hover:scale-110 transition-transform ${isDarkMode ? 'bg-black' : 'bg-gray-300 max-xl:w-[600px] max-xl:p-4'}`}>
